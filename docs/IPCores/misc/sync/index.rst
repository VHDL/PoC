...
synchonizer called :doc:`sync_Bits </IPCores/misc/sync/sync_Bits>`. PoC has two
...
+==========+=====================================================+=======================================================+====================+===================================================+===================================================+
|   1 Bit  | :doc:`sync_Bits </IPCores/misc/sync/sync_Bits>`     | :doc:`sync_Strobe </IPCores/misc/sync/sync_Strobe>`   | fifo_ic_got [#f5]_ | :doc:`sync_Reset </IPCores/misc/sync/sync_Reset>` | :doc:`sync_Pulse </IPCores/misc/sync/sync_Pulse>` |
+----------+-----------------------------------------------------+-------------------------------------------------------+--------------------+---------------------------------------------------+---------------------------------------------------+
|   n Bit  | :doc:`sync_Vector </IPCores/misc/sync/sync_Vector>` | :doc:`sync_Command </IPCores/misc/sync/sync_Command>` | fifo_ic_got [#f5]_ |                                                   |                                                   |
+----------+-----------------------------------------------------+-------------------------------------------------------+--------------------+---------------------------------------------------+---------------------------------------------------+

.. rubric:: Basic 2 Flip-Flop Synchronizer

The basic 2 flip-flop synchronizer is called :doc:`sync_Bits </IPCores/misc/sync/sync_Bits>`. It's
...
A second variant of the 2-FF synchronizer is called :doc:`sync_Reset </IPCores/misc/sync/sync_Reset>`.
...
A third variant of a 2-FF synchronizer is called :doc:`sync_Pulse </IPCores/misc/sync/sync_Pulse>`.
...
* :doc:`sync_Strobe </IPCores/misc/sync/sync_Strobe>` synchronizer ``strobe``-signals
...
* :doc:`sync_Command </IPCores/misc/sync/sync_Command>` like ``sync_Strobe``, it synchronizes
...
* :doc:`sync_Vector </IPCores/misc/sync/sync_Vector>` synchronizes a complete vector
