...
.. only:: html
   ...
   .. |gh-src| image:: /_static/logos/GitHub-Mark-32px.png
               :scale: 40
               :target: https://github.com/VHDL/PoC/blob/master/src/misc/misc_PulseTrain.vhdl
               :alt: Source Code on GitHub
   .. |gh-tb| image:: /_static/logos/GitHub-Mark-32px.png
               :scale: 40
               :target: https://github.com/VHDL/PoC/blob/master/tb/misc/misc_PulseTrain_tb.vhdl
               :alt: Source Code on GitHub
...
.. literalinclude:: ../../../src/misc/misc_PulseTrain.vhdl
   :language: vhdl
   :tab-width: 2
   :linenos:
   :lines: 41-51
