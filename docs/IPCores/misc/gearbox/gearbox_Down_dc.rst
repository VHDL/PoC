...
.. only:: html
   ...
   .. |gh-src| image:: /_static/logos/GitHub-Mark-32px.png
               :scale: 40
               :target: https://github.com/VHDL/PoC/blob/main/src/misc/gearbox/gearbox_Down_dc.vhdl
               :alt: Source Code on GitHub
   .. |gh-tb| image:: /_static/logos/GitHub-Mark-32px.png
               :scale: 40
               :target: https://github.com/VHDL/PoC/blob/main/tb/misc/gearbox/gearbox_Down_dc_tb.vhdl
               :alt: Source Code on GitHub
