...
.. only:: html
   ...
   .. |gh-src| image:: /_static/logos/GitHub-Mark-32px.png
               :scale: 40
               :target: https://github.com/VHDL/PoC/blob/main/src/net/mac/mac_RX_Type_Switch.vhdl
               :alt: Source Code on GitHub
   .. |gh-tb| image:: /_static/logos/GitHub-Mark-32px.png
               :scale: 40
               :target: https://github.com/VHDL/PoC/blob/main/tb/net/mac/mac_RX_Type_Switch_tb.vhdl
               :alt: Source Code on GitHub
