...
.. only:: html
   ...
   .. |gh-src| image:: /_static/logos/GitHub-Mark-32px.png
               :scale: 40
               :target: https://github.com/VHDL/PoC/blob/main/src/mem/sdram/sdram_ctrl_phy_de0.vhdl
               :alt: Source Code on GitHub
   .. |gh-tb| image:: /_static/logos/GitHub-Mark-32px.png
               :scale: 40
               :target: https://github.com/VHDL/PoC/blob/main/tb/mem/sdram/sdram_ctrl_phy_de0_tb.vhdl
               :alt: Source Code on GitHub
