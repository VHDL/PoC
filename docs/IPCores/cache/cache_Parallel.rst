...
.. only:: html
   ...
   .. |gh-src| image:: /_static/logos/GitHub-Mark-32px.png
               :scale: 40
               :target: https://github.com/VHDL/PoC/blob/main/src/cache/cache_Parallel.vhdl
               :alt: Source Code on GitHub
   .. |gh-tb| image:: /_static/logos/GitHub-Mark-32px.png
               :scale: 40
               :target: https://github.com/VHDL/PoC/blob/main/tb/cache/cache_Parallel_tb.vhdl
               :alt: Source Code on GitHub
...
.. literalinclude:: ../../../src/cache/cache_Parallel.vhdl
   :language: vhdl
   :tab-width: 2
   :linenos:
   :lines: 91-115
...
.. only:: latex
   ...
   Source file: :pocsrc:`cache/cache_Parallel.vhdl <cache/cache_Parallel.vhdl>`
