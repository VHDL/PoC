...
Browse the `Git directory <https://github.com/VHDL/PoC/tree/main/tools/git>`_.
...
Browse the `Notepad++ directory <https://github.com/VHDL/PoC/tree/main/tools/Notepad%2B%2B>`_.
