...
--                  Patrick Lehmann
--
-- Testbench:         Testbench for ocram_SinglePort.
--
-- Description:
-- -------------------------------------
--
...
entity ocram_SinglePort_tb is
end entity ocram_SinglePort_tb;

architecture sim of ocram_SinglePort_tb is
...
begin  -- architecture sim
	...
	uut: entity PoC.ocram_SinglePort
		generic map (
			A_BITS   => A_BITS,
			D_BITS   => D_BITS,
			FILENAME => "")
