...
--                  Gustavo Martin
--
-- Entity:          arith_Convert_Binary2BCD_Simple
--
-- Description:
-- -------------------------------------
-- Simple OSVVM test for arith_Convert_Binary2BCD
--
-- License:
-- =============================================================================
...
configuration arith_Convert_Binary2BCD_Simple of arith_Convert_Binary2BCD_TestHarness is
	for TestHarness
		for TestCtrl: arith_Convert_Binary2BCD_TestController
			use entity work.arith_Convert_Binary2BCD_TestController(Simple);
		end for;
	end for;
end configuration;
