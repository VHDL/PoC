...
--                  Gustavo Martin
--
-- Entity:          arith_Convert_Binary2BCD_TestHarness
--
-- Description:
-- -------------------------------------
-- Test harness for arith_Convert_Binary2BCD
--
-- License:
-- =============================================================================
...
entity arith_Convert_Binary2BCD_TestHarness is
end entity;

architecture TestHarness of arith_Convert_Binary2BCD_TestHarness is
	...
	component arith_Convert_Binary2BCD_TestController is
		generic (
			CONV1_BITS   : positive;
...
begin
	...
	conv1 : entity PoC.arith_Convert_Binary2BCD
		generic map (
			BITS   => CONV1_BITS,
			DIGITS => CONV1_DIGITS,
			RADIX  => 8
	...
	conv2 : entity PoC.arith_Convert_Binary2BCD
		generic map (
			BITS   => CONV2_BITS,
			DIGITS => CONV2_DIGITS,
			RADIX  => 2
	...
	TestCtrl: component arith_Convert_Binary2BCD_TestController
		generic map (
