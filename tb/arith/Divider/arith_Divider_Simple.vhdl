...
--                  Gustavo Martin
--
-- Entity:          arith_Divider_Simple
--
-- Description:
-- -------------------------------------
-- Simple test for arith_Divider
--
-- License:
-- =============================================================================
...
architecture Simple of arith_Divider_TestController is
	signal TestDone : integer_barrier := 1;
	constant TCID : AlertLogIDType := NewID("DividerTest");
...
begin
	...
	begin
		...
		SetTestName("arith_Divider_Simple");
	...
	TestProc : process
		...
		begin
			...
			for i in done'range loop
				if dval = 0 then
					AffirmIf(ZZ(i) = '1', "INST=" & integer'image(i) & " Divider by zero check failed: " & integer'image(aval) & "/" & integer'image(dval));
				else
...
configuration arith_Divider_Simple of arith_Divider_TestHarness is
	for tb
		for TestCtrl: arith_Divider_TestController
			use entity work.arith_Divider_TestController(Simple);
		end for;
	end for;
end configuration;
