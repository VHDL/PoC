...
include ./HighResolutionClock/RunAllTests.pro
include ./OCRAM_Adapter/RunAllTests.pro
include ./Register/RunAllTests.pro
disabled ./SimpleInterface/RunAllTests.pro
