...
begin
	...
	begin
		...
		begin
			...
			for j in 1 to 64 loop
				GetWriteAddress(SubordinateRec(i), Address);
				GetAxi4Options(SubordinateRec(i), AWID, ID);
				SetAXI4Options(SubordinateRec(i), BID, ID);
				GetWriteData(SubordinateRec(i), Data);
			...
			for j in 1 to 64 loop
				GetReadAddress(SubordinateRec(i), Address);
				GetAxi4Options(SubordinateRec(i), ARID, ID);
				SetAXI4Options(SubordinateRec(i), RID, ID);
				SendReadData(SubordinateRec(i), to_slv(X"0000_0000" + j));
