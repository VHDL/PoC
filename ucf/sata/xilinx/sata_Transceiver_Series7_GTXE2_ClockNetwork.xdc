# This XDC file must be directly applied to all instances of sata_Transceiver_Series7_GTXE2_ClockNetwork.
# To achieve this, set property SCOPED_TO_REF to sata_Transceiver_Series7_GTXE2_ClockNetwork within the Vivado project.
