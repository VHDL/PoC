...
class Simulator(BaseSimulator):
	...
	def _RunSimulation(self, testbenchName):
		...
		tclBatchFilePath =		self.Host.Directories["PoCRoot"] / self.Host.PoCConfig[self._testbenchFQN]['vSimBatchScript']
	...
	def _RunSimulationWithGUI(self, testbenchName):
		...
		tclGUIFilePath =			self.Host.Directories["PoCRoot"] / self.Host.PoCConfig[self._testbenchFQN]['vSimGUIScript']
		tclWaveFilePath =			self.Host.Directories["PoCRoot"] / self.Host.PoCConfig[self._testbenchFQN]['vSimWaveScript']
