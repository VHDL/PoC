...
entity uart_RX is
	...
	port (
		...
		SampleClock : in  std_logic;    -- bit clock, eight strobes per bit length
		RX          : in  std_logic;
...
begin
	...
	sync :  entity work.sync_Bits
		...
		port map (
			Clock          => Clock,    -- <Clock>  output clock domain
