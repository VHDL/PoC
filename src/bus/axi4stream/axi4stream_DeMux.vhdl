...
--                  Stefan Unrein
--
-- Entity:          A generic AXI4-Stream de-multiplexer.
--
-- Description:
-- -------------------------------------
-- This module takes a input AXI4Stream and forwards it to one or more outputs
-- based on the 'DeMuxControl' input. 'DeMuxControl' is one-hot encoded.
-- If ADD_MIRROR_MODE is used, this module can forward a packet to multiple
-- destinations at the same time. Every set output by 'DeMuxControl' gets a copy
-- of the input packet.
-- OUTPUT_STAGES: Provides number of pipelining-stages on every output port.
-- Note: If ADD_MIRROR_MODE is used, a combinatorial loop could be created
-- depending on the data source and sink. In this case, a OUTPUT_STAGE can
-- resolve this.
--
-- License:
-- =============================================================================
