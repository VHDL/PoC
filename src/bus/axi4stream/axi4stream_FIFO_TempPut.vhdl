...
begin
	...
	generic map (
		RAM_TYPE       => RAM_TYPE,
		DATA_BITS         => ite(USER_IS_DYNAMIC and (USER_BITS > 0), isum(Data_Bits_Vec), isum(Data_Bits_Vec(0 to Last_Pos))),                -- Data Width
		...
		EMPTY_STATE_BITS => EMPTY_STATE_BITS,                            -- Empty State Bits
		FILL_STATE_BITS => FILL_STATE_BITS                            -- Full State Bits
	)
	port map (
