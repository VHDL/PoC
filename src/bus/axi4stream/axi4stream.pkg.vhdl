...
package body axi4stream is
	...
	begin
		assert get_TotalDataBits(In_M2S) = Serialized'length report "axi4stream.get_LastFromSerialized:: Size of Serialized Data does not metch packing size of In_M2S!" severity failure;
