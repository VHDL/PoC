...
architecture rtl of GMII_SGMII_clk_gen is
...
begin
  ...
  -- frequencies
  clk_div_stage1: ENTITY L_Ethernet.GMII_SGMII_johnson_cntr
    port map (
    reset       => reset,
    clk         => clk125m,  -- 125MHz
    clk_en      => '1',
  ...
  -- clock frequencies
  clk_div_stage2: ENTITY L_Ethernet.GMII_SGMII_johnson_cntr
    port map (
    reset       => reset,
    clk         => clk125m,          -- 125MHz
