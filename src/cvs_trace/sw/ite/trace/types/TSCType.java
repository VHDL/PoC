...
/**
 * Trigger-SensitiveComponent-Types
 * 
 * @author stefan alex
 * 
 */
public enum TSCType {
	 ...
	 * @param id a id-value
	 */
	private TSCType(String s, int id) {
		this.s = s;
		this.id = id;
	}
	 ...
	 * if none exists
	 */
	public static TSCType get(int i) {
		for (TSCType tt : TSCType.values())
			if (tt.id == i)
				return tt;
		return null;
	}
