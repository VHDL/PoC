...
-- immediately (combinatorial) whether the ``Address`` is stored within the cache, or not.
...
entity cache_TagUnit_Parallel is
	generic (
...
begin
	...
	begin
		...
		-- replacement policy
		Policy: entity work.cache_ReplacementPolicy
			generic map (
