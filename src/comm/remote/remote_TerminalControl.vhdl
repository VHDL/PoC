...
entity remote_TerminalControl is
	generic (
		RESET_COUNT  : natural;
		PULSE_COUNT  : natural;
	...
	port (
		...
		-- UART Connectivity
		-- XXX: discusss UART interface: UART_* signals don't match UART naming, why 7 bits? Parity?
...
architecture rtl of remote_TerminalControl is
